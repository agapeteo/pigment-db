...
Status: preserved immutable evidence; invalid for protocol-v2 acceptance

Invalidation reason: the start-only eight-worker schedule let a reference worker
repeatedly reacquire the mutex and hide serialized queue wait from p95.
...
The immutable raw sample rows are in `protocol-v1-reference-20260807.csv`.
