...
- [X] T094 [US3] Write and run a runtime RED proving key/set ordinary and compute acceptance follows the lock order while async user work/cancellation occurs outside maintenance coordination in `src/mutation_ordering_tests/key_set.rs`
